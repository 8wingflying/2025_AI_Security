# 🤖 Awesome Agents
- [整理與擴充自](https://github.com/kyrolabs/awesome-agents)
...
- [Awesome Agents](#awesome-agents)
  ...
  - 🆕[Scientific AI Agent](#Scientific)
  - 🆕[Sceurity](#Security)
## Frameworks
...
- 參考並擴充 [Survey on Evaluation of LLM-based Agents(arXiv:2503.16416)](https://arxiv.org/abs/2503.16416)
...
### Security
- https://arxiv.org/search/?query=agent+security&searchtype=all&source=header
- agent phishing ==> https://arxiv.org/search/?query=agent+phishing&searchtype=all&abstracts=show&order=-announced_date_first&size=50
- agent fakenews ==> https://arxiv.org/search/?query=agent+fake+news&searchtype=all&abstracts=show&order=-announced_date_first&size=50
- 攻擊面
  - 🎯[Against The Achilles' Heel: A Survey on Red Teaming for Generative Models(arXiv:2404.00629)](https://arxiv.org/abs/2404.00629)
  ...
  - [Automating Privilege Escalation with Deep Reinforcement Learning(arXiv:2110.01362)](https://arxiv.org/abs/2110.01362)
- 資安防禦
  - [Autonomous Network Defence using Reinforcement Learning(arXiv:2409.18197)](https://arxiv.org/abs/2409.18197) 
- 資安檢測與服務
  - [AutoPenBench: Benchmarking Generative Agents for Penetration Testing(arXiv:2410.03225)](https://arxiv.org/abs/2410.03225)
  - [Interactive Tools Substantially Assist LM Agents in Finding Security Vulnerabilities(arXiv:2409.16165)](https://arxiv.org/abs/2409.16165)
  - [Multi-lingual Multi-turn Automated Red Teaming for LLMs(arXiv:2504.03174)](https://arxiv.org/abs/2504.03174)
  - [Strategize Globally, Adapt Locally: A Multi-Turn Red Teaming Agent with Dual-Level Learning(arXiv:2504.01278)](https://arxiv.org/abs/2504.01278)
  - [AutoRedTeamer: Autonomous Red Teaming with Lifelong Attack Integration(arXiv:2503.15754)](https://arxiv.org/abs/2503.15754)
  - [Red-Teaming LLM Multi-Agent Systems via Communication Attacks(arXiv:2502.14847)](https://arxiv.org/abs/2502.14847)
  - [Automated Red Teaming with GOAT: the Generative Offensive Agent Tester(arXiv:2410.01606)](https://arxiv.org/abs/2410.01606)
